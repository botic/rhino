                                                  ...
                                                  ConstProperties
{
    ...
    private static final int HASH_SEED = System.identityHashCode(ScriptableObject.class)
    ...
    private static int mm3_hash32(final CharSequence data) {
    ...
    private Slot getSlot(String name, int index, int accessType)
    {
        ...
        int indexOrHash = (name != null ? mm3_hash32(name) : index);
